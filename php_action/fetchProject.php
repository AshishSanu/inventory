...
$sql = "SELECT project.project_id, project.project_name, project.project_team, project.project_duration,
 		project.project_start_date, project.project_end_date, project.status FROM project 
